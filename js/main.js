...
if (btnCalcular!=null) {
    btnCalcular.addEventListener("click", function calcula() {
...
let btnCalcularAl = document.querySelector(".btnCalcularAl");
if (btnCalcularAl!=null) {
    btnCalcularAl.addEventListener("click", function calculaAl() {
